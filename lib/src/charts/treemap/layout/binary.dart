...
class BinaryLayout extends HierarchyLayout<TreeMapData,TreeMapSeries> {
  @override
  void onLayout(TreeMapData data, var params) {
    Rect area = params.boxBound;
    BinaryNode binaryNode = _convertToBinaryNode(null, data, false);
