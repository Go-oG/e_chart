...
class LineGridView extends GridView<StackItemData, LineGroupData, LineSeries, LineGridHelper> {
  late LineHelper helper;

  LineGridView(super.context, super.series);
  ...
  @override
  LineGridHelper buildLayoutHelper(LineGridHelper? oldHelper) {
    oldHelper?.clearRef();
