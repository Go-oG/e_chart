...
class LegendItemView extends ChartView {
  ...
  void onDraw(Canvas canvas) {
    ...
    if (p == Position.left) {
      ...
      item.symbol.draw(canvas, mPaint, SymbolDesc(center: o));
    } else if (p == Position.right) {
      item.symbol.draw(canvas, mPaint, SymbolDesc(center: Offset(symbolSize.width / 2, height / 2)));
      ...
      item.symbol.draw(canvas, mPaint, SymbolDesc(center: Offset(width / 2, height - symbolSize.height / 2)));
